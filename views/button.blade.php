<{{ $element }} {{ $attributes }} 
	@class(array_merge([$className], [
		...
		// 'text-white' => (strpos( $className, 'text-') === false),
		'flex w-full' => $full,
	...
	])) x-bind:disabled="(typeof loading != 'undefined' ? loading : false)" :class="(typeof loading != 'undefined' ? loading : false) ? 'pointer-events-none cursor-not-allowed' : ''">
